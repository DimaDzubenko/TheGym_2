...
namespace TheGym_2.Controllers
{
    public class SpecializationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title")] Specialization specialization)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title")] Specialization specialization)
        {
            if (ModelState.IsValid)
            {
